...
export function Header() {
  return (
    <header className="navbar navbar-expand-lg navbar-dark bd-navbar sticky-top bg-primary">
      <nav
        className="container-xxl bd-gutter flex-wrap flex-lg-nowrap"
        aria-label="Main navigation"
      >
        <div className="w-25 d-lg-none"></div>
        ...
        >
          ...
          <div className="offcanvas-body p-4 pt-0 p-lg-0">
            ...
            <ul className="navbar-nav flex-row flex-wrap bd-navbar-nav text-primary">
              <li className="nav-item col-6 col-lg-auto ">
                <a
                  className="nav-link py-2 px-0 px-lg-2 text-white "
            ...
            <ul className="navbar-nav flex-row flex-wrap ms-md-auto">
              <li className="nav-item col-6 col-lg-auto">
                <a
                  className="nav-link py-2 px-0 px-lg-2 fw-bold text-white"
                ...
                >
                  <svg
                    ...
                    width="16"
                    height="16"
                    className="navbar-nav-svg fw-bold text-white"
              ...
              <li className="nav-item dropdown">
                <button
                  type="button"
                  className="btn btn-link nav-link py-2 px-0 px-lg-2 dropdown-toggle fw-bold text-white"
                ...
                >
                  ...
                  <span className="visually-hidden">Bootstrap&nbsp;</span> v5.2{" "}
